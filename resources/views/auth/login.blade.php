                        ...
                        @csrf
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="ID@TaskGo.vn" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="********" required autocomplete="current-password">
                                ...
                                <div class="social">
                                    ...
                                    <a href="javascript:void(0);" class="btn text-dark">
