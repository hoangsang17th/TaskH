                                ...
                                <div class="compose-box">
                                    <div class="compose-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="d-flex mb-4 mail-form">
                                                        <select class="" id="m-form" hidden>
                                                            <option value="taskgo47@mail.com">Info &lt;info@mail.com&gt;</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex mb-4 mail-subject">
                                                ...
                                                <div class="w-100">
                                                    <input type="email" value="TaskGo47@mail.com" class="form-control" disabled>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="d-flex mb-4 mail-to">
                                                        ...
                                                        <div class="">
                                                            <input type="email" id="m-to" placeholder="To" class="form-control" name="To">
                                                            <span class="validation-text"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex">
                                                <input type="file" class="form-control-file" id="mail_File_attachment" multiple="multiple" hidden>
                                            </div>

                                            <div id="editor-container">
                                                Trong khoảng thời gian bảo trì, tại một vài thời điểm chức năng quản lý dự án có thể tạm thời bị gián đoạn trong khoảng thời gian ngắn
                                            </div>
