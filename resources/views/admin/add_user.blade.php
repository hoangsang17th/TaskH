        ...
        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <form class="section general-info" action="{{ route('accounts.store')}}" method="POST">
                        @csrf
                        <div class="info">
                            <h6 class="text-center">Add Account</h6>
                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control mb-4" name="email" id="email" type="email">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="email">Password</label>
                                                            <input type="text" class="form-control mb-4" value="@TaskGo.com" name="password">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Position</label>
                                                            <select name="Position_ID" id="" class="form-control mb-4" >
